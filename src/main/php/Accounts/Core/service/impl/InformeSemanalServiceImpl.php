...
use Accounts\Core\service\IInformeSemanalService;
...
class InformeSemanalServiceImpl extends CrudService implements IInformeSemanalService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Accounts/Core/service/Accounts\Core\service.IInformeSemanalService::getInformeAnualPorMes()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Accounts/Core/service/Accounts\Core\service.IInformeSemanalService::getInformeAnualPorSemana()
	 */
