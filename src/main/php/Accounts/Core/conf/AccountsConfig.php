...
class AccountsConfig {
	...
	private $appPathCore = "D:/Documents/Mis Webs/accounts_core";

	const PROXIES_NAMESPACE="accounts\\Core\\Proxies";
	const PROXIES_PATH=  "/Proxies";

	const TEST_MODE = true;
	const MAIL_FROM_NAME = "Accounts";
