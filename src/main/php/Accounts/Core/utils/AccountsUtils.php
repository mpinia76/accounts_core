...
class AccountsUtils {
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		$libsHome= AccountsConfig::getInstance()->getLibsPath();
        ...
        if( AccountsConfig::TEST_MODE ){
        	//me los envío todos a mi en test
        	$to = AccountsConfig::TEST_MAIL_TO;
        }
		...
		$mail->Host = AccountsConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = AccountsConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = AccountsConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = AccountsConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = AccountsConfig::POP_MAIL_PASSWORD;

		//Set who the message is to be sent from
		$mail->setFrom(AccountsConfig::MAIL_FROM, AccountsConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(AccountsConfig::MAIL_FROM, AccountsConfig::MAIL_FROM_NAME);
    ...
    public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
        ...
        if (AccountsConfig::MAIL_ENVIO_POP)
