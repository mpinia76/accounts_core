 ...
 * Transferencia
 *
 * Transferencia entre accounts
 *
 * @Entity @Table(name="accounts_transferencia")
 *
*  @author Marcos
 * @since 02-08-2018
 */
...
class Transferencia extends Entity{
	...
	public function __toString(){
		 return $this->getOrigen() . " -> " . $this->getDestino() . " : " . AccountsUtils::formatMontoToView( $this->getMonto() );
	}
