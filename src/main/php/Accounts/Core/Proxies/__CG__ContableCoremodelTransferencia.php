...
namespace accounts\Core\Proxies\__CG__\Accounts\Core\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Transferencia extends \Accounts\Core\model\Transferencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'fechaHora', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'monto', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'estado', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'observaciones', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'origen', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'destino', '' . "\0" . 'Accounts\\Core\\model\\Transferencia' . "\0" . 'user'];
        }
